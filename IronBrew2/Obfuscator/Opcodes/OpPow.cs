...
namespace IronBrew2.Obfuscator.Opcodes
{
	public class OpPow : VOpcode
	{
		...
		public override string GetObfuscated(ObfuscationContext context) =>
			"Stk[Inst[OP_A]]=(Stk[Inst[OP_B]]^Stk[Inst[OP_C]]) + (0 * math.floor(math.random()));";
	}
	...
	public class OpPowB : VOpcode
	{
		...
		public override string GetObfuscated(ObfuscationContext context) =>
			"Stk[Inst[OP_A]]= (Inst[OP_B] ^ Stk[Inst[OP_C]]) + (0 * math.floor(math.random()));";
	...
	public class OpPowC : VOpcode
	{
		...
		public override string GetObfuscated(ObfuscationContext context) =>
			"Stk[Inst[OP_A]]= (Stk[Inst[OP_B]]^ Inst[OP_C]) + (0 * math.floor(math.random()));";
	...
	public class OpPowBC : VOpcode
	{
		...
		public override string GetObfuscated(ObfuscationContext context) =>
			"Stk[Inst[OP_A]] = (Inst[OP_B] ^ Inst[OP_C]) + (0 * math.floor(math.random()));";
