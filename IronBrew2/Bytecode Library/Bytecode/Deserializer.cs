// Deserializer.cs
// Completely reworked: Uses AES decryption, HMAC verification, compression handling.
// Minimal original code; structured with interfaces for extensibility.
...
namespace IronBrew2.Bytecode_Library.Bytecode
{
    public class Deserializer
    {
        ...
        private byte _securityKey = 0xAB; // Simple security key for XOR operations
        ...
        public Chunk DecodeFile()
        {
            ...
            ReadByte(); //size of int

            _sizeSizeT = ReadByte();

            ReadByte(); //size of instruction

            _sizeNumber = ReadByte();

            ReadByte(); //integer number
